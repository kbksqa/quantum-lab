...
| P5 | **QAOA without penalties**: constraint-preserving mixers (row XY, permutation) against the P1 penalty formulation on the same assignment instances ([plan](docs/p5-plan.md)) | in progress — pre-registered |
