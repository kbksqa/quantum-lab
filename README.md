...
| P4 | Technical report on P0–P3, archived with a DOI ([plan](docs/p4-plan.md)) | in progress — P4.0 decisions made; P4.1 machine-checked numbers table and script-generated figures in `paper/` (CC BY 4.0) |
