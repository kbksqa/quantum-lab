...
| P1 | Assignment / data association as QUBO — brute force vs simulated annealing vs QAOA ([plan](docs/p1-plan.md)) | in progress — P1.0 baseline · P1.1 QUBO gate passed (588 / 588) · P1.2 penalty study done |
