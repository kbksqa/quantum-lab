...
| P1 | Assignment / data association as QUBO — brute force vs simulated annealing vs QAOA ([plan](docs/p1-plan.md)) | in progress — P1.0 baseline done · P1.1 QUBO gate passed (588 / 588) |
