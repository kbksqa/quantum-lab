...
| P2 | **Multi-sensor data association benchmark**: three-dimensional assignment (NP-hard) with exact ILP, Lagrangian relaxation, annealing and QAOA baselines ([plan](docs/p2-plan.md)) | in progress — P2.0–P2.5 done: [benchmark](benchmark/p2/README.md) of 1,620 instances with exact optima, a checker and baselines (v0.4.0); QUBO gate 517 / 517; H2 and H3 partly held; H4 failed; 3D QAOA passes the hardware go rule only at depth 1 on sparse instances |
