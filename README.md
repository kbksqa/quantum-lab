...
| P2 | **Multi-sensor data association benchmark**: three-dimensional assignment (NP-hard) with exact ILP, Lagrangian relaxation, annealing and QAOA baselines ([plan](docs/p2-plan.md)) | in progress — P2.0–P2.1 done: exact ILP equals brute force on 888 / 888; H4 failed (optimum = truth only 27% at T = 3), diagnosed in the log |
